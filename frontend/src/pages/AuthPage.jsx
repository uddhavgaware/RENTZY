        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          ...
          <div className="bg-white dark:bg-gray-900 py-8 px-6 sm:px-8 shadow-xl shadow-gray-200/50 dark:shadow-black/50 rounded-2xl border border-gray-100 dark:border-gray-800">
            ...
            <div className="mb-6 flex flex-col items-center gap-3">
              {isNativePlatform() ? (
                <button onClick={() => setError('Google Login is not supported in the mobile app yet. Please use Email or Truecaller.')} className="w-full max-w-[250px] bg-white border border-gray-300 text-gray-700 py-2 rounded-full text-sm font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors">
