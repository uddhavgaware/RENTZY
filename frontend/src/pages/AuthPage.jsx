        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          ...
          <div className="bg-white dark:bg-gray-900 py-8 px-6 sm:px-8 shadow-xl shadow-gray-200/50 dark:shadow-black/50 rounded-2xl border border-gray-100 dark:border-gray-800">
            ...
            <div className="mb-6 flex justify-center">
              ...
              {/* Truecaller Login for Native Apps */}
              {isNativePlatform() && (
                <button 
                  onClick={async () => {
                    try {
                  ...
                  className="w-full max-w-[250px] mt-3 bg-[#2F5299] text-white py-2 rounded-full text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#203D78] transition-colors shadow-sm"
                >
                  {/* Custom minimal Truecaller icon SVG */}
