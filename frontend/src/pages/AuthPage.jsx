...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* ─── RIGHT: Form Panel ─── */}
      <div className="flex-1 flex flex-col justify-start md:justify-center py-12 px-4 sm:px-6 lg:px-12 xl:px-20 bg-mesh-gradient relative overflow-y-auto max-h-screen">
            ...
            <div className="mb-6 flex flex-col items-center gap-3">
              {isNativePlatform() ? (
                <button 
                  ...
                  className="w-full max-w-[250px] bg-white border border-gray-300 text-gray-700 py-2 rounded-full text-sm font-medium flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
                >
                  ...
                  <form className="space-y-5" onSubmit={handleEmailSubmit}>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input type="password" name="password" autoComplete={isLogin ? "current-password" : "new-password"} required className="appearance-none block w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all text-gray-900 font-medium" placeholder="••••••••" />
                      </div>
                    </div>
                      ...
                      <button 
                        onClick={() => {
                          ...
                          if (isAndroid || isIOS) {
                            ...
                            setError('Truecaller Login is only supported on the RentXY mobile app or mobile browsers.');
                          }
                        }}
