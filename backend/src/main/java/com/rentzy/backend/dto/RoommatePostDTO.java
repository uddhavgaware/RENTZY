...
public class RoommatePostDTO {
    ...
    public static RoommatePostDTO fromEntity(RoommatePost post) {
        ...
        return RoommatePostDTO.builder()
            ...
            .preferences(post.getPreferences() == null ? null : new java.util.ArrayList<>(post.getPreferences()))
            ...
            .images(post.getImages() == null ? null : new java.util.ArrayList<>(post.getImages()))
            .user(userDTO)
